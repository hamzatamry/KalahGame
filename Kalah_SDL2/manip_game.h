...
extern int Jouer_Mise_aJour(pile plateau[2][8], int dernier_jouer, int *num_creux);   //Mise a jour du plateau apres le coup
...
extern int DeciderGagnant(pile kalah1, pile kalah2);
