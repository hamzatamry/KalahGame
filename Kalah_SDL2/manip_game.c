...
int Jouer_Mise_aJour(pile plateau[2][8], int dernier_joueur, int *num_creux)  //dernier joueur : joueur qui a joueé le dernier coup
{
...
int DeciderGagnant(pile kalah1, pile kalah2)
{
