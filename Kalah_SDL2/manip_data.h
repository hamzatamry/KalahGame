...
int Sauvegarder(char Donnee_Texte[4][30], pile plateau[2][8], int dernier_joueur, int nb_moitie); //Sauvegarder la partie jouee dans un fichier binaire portant le nom de la partie
